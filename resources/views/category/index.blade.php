@extends('layouts.app')
@section('title', 'Admin :: ' . __('Category'))
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row mb-3 justify-content-end">
                            ...
                            {{-- <div class="col-sm-2 mt-2">
                                <button class="btn btn-primary w-100 search_btn" id="search-btn">Search</button>
                            </div> --}}
                            <div class="col-sm-2 mt-2">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('category.store') }}" method="post" id="category_store_frm"
                    name="category_store_frm">
                    @csrf
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" id="proccess_btn">Add</button>
                        <a href="javascript:;" class="btn btn-danger" onclick="closeCustomModal()">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function validateCategoryStoreForm() {
            $('#category_store_frm').each(function() {
                $(this).validate({
                    errorElement: 'div',
