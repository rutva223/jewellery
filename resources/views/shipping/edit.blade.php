@extends('layouts.app')
@section('title', 'Admin :: ' . __('Edit Shipping Method'))
...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('shipping-methods.update', $shippingMethod->id) }}" method="post" id="shipping-form">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       name="name" value="{{ old('name', $shippingMethod->name) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('type') is-invalid @enderror" name="type" id="type" required>
                                    ...
                                    <option value="free" {{ old('type', $shippingMethod->type) == 'free' ? 'selected' : '' }}>Free Shipping</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" min="0" 
                                       ...
                                       name="cost" value="{{ old('cost', $shippingMethod->cost) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" min="0" 
                                       ...
                                       name="minimum_order_amount" value="{{ old('minimum_order_amount', $shippingMethod->minimum_order_amount) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" min="0" 
                                       ...
                                       name="sort_order" value="{{ old('sort_order', $shippingMethod->sort_order) }}" 
                            ...
                            <div class="mb-3">
                                <div class="form-check mt-4">
                                    <input type="checkbox" class="form-check-input" name="is_active" id="is_active" 
                                           value="1" {{ old('is_active', $shippingMethod->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description for customers">{{ old('description', $shippingMethod->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
