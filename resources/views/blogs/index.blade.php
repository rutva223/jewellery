                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row mb-3 justify-content-end">
                            ...
                            <div class="col-sm-2 mt-2">
                                <a href="{{ route('blogs.create') }}" class="btn btn-primary w-100">
...
<script>
    ...
    function openHeadline(name) {
        Swal.fire({
            title: "<h6>HeadLine :- " + name + "</h6>",
            icon: "warning",
            confirmButtonText: "Ok",
        });
    }
