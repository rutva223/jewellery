@extends('layouts.app')
@section('title', 'Admin :: ' . __('Blog Create'))
...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <form action="{{ route('blogs.store') }}" method="post" enctype="multipart/form-data" name="blog_sub_form" id="blog_sub_form">
                        @csrf
                        <div class="row">
                            <div class="col-sm-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-secondary">
                                <input type="text" class="form-control" name="title" id="title" required placeholder="Enter Blog Title.">
                            </div>
                            <div class="col-sm-2">
                                <h6 class="mb-0">Headline</h6>
                            </div>
                            <div class="col-sm-4 text-secondary">
                                <input type="text" class="form-control" name="headline" id="headline" required placeholder="Enter Headline">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                <img id="blah2" src="{{ asset('image/preview_image.png') }}" height="50px" width="50px">
                            </div>
                        </div>
                        <br />
                        <div class="row">
