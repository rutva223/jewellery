            ...
            <div class="section-container">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 header-center">
                        <div class="site-logo">
                            <a href="index.html">
                                <img width="400" height="79" src="{{ asset('front_end/media/logo-white.png')}}" alt="Mojuri – Jewelry Store HTML Template" />
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div class="cart-list-wrap">
                                        <ul class="cart-list ">
                                            <li class="mini-cart-item">
                                                ...
                                                <a href="shop-details.html" class="product-image"><img width="600" height="600" src="{{ asset('front_end/media/product/3.jpg')}}" alt=""></a>
                                            ...
                                            <li class="mini-cart-item">
                                                <a href="index.html#" class="remove" title="Remove this item"><i class="icon_close"></i></a>
                                                <a href="shop-details.html" class="product-image"><img width="600" height="600" src="{{ asset('front_end/media/product/1.jpg')}}" alt=""></a>
                ...
                <div class="section-container large p-l-r">
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 header-left">
                            <div class="site-logo">
                                <a href="index.html">
                                    <img width="400" height="140" src="{{ asset('front_end/media/logo-white.png')}}" alt="Mojuri – Jewelry Store HTML Template" />
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="site-navigation">
                                <nav id="main-navigation">
                                    <ul id="menu-main-menu" class="menu">
                                                                ...
                                                                <ul class="posts-list">
                                                                    <li class="post-item">
                                                                        <a href="blog-details-right.html" class="post-image">
                                                                            <img src="{{ asset('front_end/media/blog/1.jpg')}}">
                                                                        </a>
                                                                    ...
                                                                    <li class="post-item">
                                                                        <a href="blog-details-right.html" class="post-image">
                                                                            <img src="{{ asset('front_end/media/blog/2.jpg')}}">
                                                                        </a>
                                                                        <div class="post-content">
                                                                            <h2 class="post-title">
                                                                                <a href="blog-details-right.html">
                                                                    ...
                                                                    <li class="post-item">
                                                                        <a href="blog-details-right.html" class="post-image">
                                                                            <img src="{{ asset('front_end/media/blog/3.jpg')}}">
                                                                        </a>
                                                                        <div class="post-content">
                                                                            <h2 class="post-title">
                                                                                <a href="blog-details-right.html">
                                        ...
                                        <li class="level-0 menu-item menu-item-has-children">
                                            <a href="index.html#"><span class="menu-item-text">Pages</span></a>
                                            <ul class="sub-menu">
                                                <li>
                                                        ...
                                                        <div class="content">
                                                            ...
                                                            <div class="rememberme-lost">
                                                                ...
                                                                <div class="lost_password">
                                                                    <a href="https://caketheme.com/html/mojuri/forgot-password.html">Lost your password?</a>
                                                                </div>
                                                            </div>
