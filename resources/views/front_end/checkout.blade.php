                                    ...
                                    <div class="billing-fields-wrapper">
                                        ...
                                        <p class="form-row form-row-wide validate-required">
                                            ...
                                            <span class="input-wrapper">
                                                <select name="billing_country" class="country-select custom-select select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                                ...
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 189.333px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-billing_country-b3-container"><span class="select2-selection__rendered" id="select2-billing_country-b3-container" title="Select a country / region…">Select a country / region…</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </span>
                                        </p>
                                        ...
                                        <p class="form-row address-field validate-required validate-state form-row-wide">
                                            ...
                                            <span class="input-wrapper">
                                                <select name="billing_state" class="state-select custom-select select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                                ...
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 175.333px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-billing_state-j5-container"><span class="select2-selection__rendered" id="select2-billing_state-j5-container" title="Select a state / county…">Select a state / county…</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </span>
                                        </p>
                                    ...
                                    <p class="form-row form-row-wide address-field validate-required">
                                        ...
                                        <span class="input-wrapper">
                                            <select name="billing_state" class="state-select custom-select select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                                ...
                                                <option value="DT">Donetsk Oblast</option>
                                                <option value="ZT">Zhytomyr Oblast</option>
                                            </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 189.333px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-billing_state-1n-container"><span class="select2-selection__rendered" id="select2-billing_state-1n-container" title="Select a country / region…">Select a country / region…</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </span>
                                    </p>
                                    <p class="form-row address-field validate-required form-row-wide">
                                        <label>Street address <span class="required" title="required">*</span></label>
                                    ...
                                    <p class="form-row address-field validate-required validate-state form-row-wide">
                                        ...
                                        <span class="input-wrapper">
                                            <select name="billing_state" class="state-select custom-select select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                                ...
                                                <option value="DT">Donetsk Oblast</option>
                                                <option value="ZT">Zhytomyr Oblast</option>
                                            </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 175.333px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-billing_state-tr-container"><span class="select2-selection__rendered" id="select2-billing_state-tr-container" title="Select a state / county…">Select a state / county…</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </span>
                                    </p>
                                    <p class="form-row address-field validate-required validate-postcode form-row-wide">
                                        <label>Postcode / ZIP <span class="required" title="required">*</span></label>
