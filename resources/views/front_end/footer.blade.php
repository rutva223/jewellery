                        ...
                        <div class="col-md-6">
                            <div class="footer-right">
                                <div class="block block-image">
                                    <img width="309" height="32" src="{{ asset('front_end/media/payments.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <table class="wishlist-items">
                <tbody>
                    <tr class="wishlist-item">
                        ...
                        <td class="wishlist-item-image">
                            <a href="shop-details.html">
                                <img width="600" height="600" src="{{ asset('front_end/media/product/3.jpg')}}" alt="">
                            </a>
                           </td>
                    ...
                    <tr class="wishlist-item">
                        ...
                        <td class="wishlist-item-image">
                            <a href="shop-details.html">
                                <img width="600" height="600" src="{{ asset('front_end/media/product/4.jpg')}}" alt="">
                            </a>
                           </td>
                        <td class="wishlist-item-info">
                            <div class="wishlist-item-name">
                ...
                <table id="product-table" class="product-table">
                    ...
                    <tbody>
                        <tr class="tr-image">
                            ...
                            <td>
                                <a href="shop-details.html">
                                    <img width="600" height="600" src="{{ asset('front_end/media/product/1.jpg')}}" alt="">
                                </a>
                            </td>
                            <td>
                                <a href="shop-details.html">
                                    <img width="600" height="600" src="{{ asset('front_end/media/product/2.jpg')}}" alt="">
                                </a>
                            </td>
                        </tr>
                        <tr class="tr-sku">
                                        ...
                                        <div class="slick-wrap">
                                            <div class="slick-sliders image-additional" data-dots="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true">
                                                <div class="img-thumbnail slick-slide">
                                                    <a href="{{ asset('front_end/media/product/3.jpg')}}" class="image-scroll" title="">
                                                        <img width="900" height="900" src="{{ asset('front_end/media/product/3.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                                <div class="img-thumbnail slick-slide">
                                                    <a href="{{ asset('front_end/media/product/3-2')}}.jpg" class="image-scroll" title="">
                                                        <img width="900" height="900" src="{{ asset('front_end/media/product/3-2.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="quickview-single-info">
                        <div class="product-content-detail entry-summary">
                            ...
                            <div class="product-rating">
                                ...
                                <a href="index.html#" class="review-link">(<span class="count">1</span> customer review)</a>
                            </div>
