                            ...
                            <div class="item-info horizontal-start vertical-middle">
                                <div class="content">
                                    ...
                                    <a class="button-slider button button-white button-outline thick-border"
                                        href="{{ route('catwiseproduct') }}">Explore Bestseller</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="banner-wrapper-infor">
                                                <div class="info">
                                                    <div class="content">
                                                        ...
                                                        <a class="button" href="{{ route('catwiseproduct') }}">Shop Now</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="banner-wrapper-infor text-center">
                                                <div class="info">
                                                    <div class="content">
                                                        ...
                                                        <a class="button center" href="{{ route('catwiseproduct') }}">Shop
                                                            Now</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="banner-wrapper-infor">
                                                <div class="info">
                                                    <div class="content">
                                                        ...
                                                        <a class="button" href="{{ route('catwiseproduct') }}">Shop
                                                            Now</a>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="intro-item">
                                <div class="icon">
                                    <span class="wrap animation-horizontal">
                                        <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" height="100%"
                                            viewBox="0 0 512.001 512.001" width="100%">
                                            <g>
                                                <g>
                                                    <g>
                                                        <g>
                                ...
                                <div class="content">
                                    ...
                                    <div class="text">Nullam quis ante. Pellentesque libero tortor, tincidunt et,
                                        tinciduntamet est.In hac habitasse platea dictumst. Praesent nec nisl a purus
                                        blandit viverra</div>
                                </div>
                            </div>
                            <div class="intro-item">
                                <div class="icon">
                                    <span class="wrap animation-horizontal">
                                        <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" height="100%"
                                            viewBox="0 0 511.985 511.985" width="100%">
                                            <g>
                                                <g>
                                                    <path
                    ...
                    <div class="section-column right">
                        <a href="index.html#">
                            <img class="hover-opacity" width="820" height="674"
                                src="{{ asset('front_end/media/banner/intro-1.jpg') }}" alt="intro">
                        </a>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="info">
                                                    <div class="content">
                                                        ...
                                                        <a class="button button-outline thick-border border-white button-arrow"
                                                            href="{{ route('catwiseproduct') }}">Explore</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="block-widget-wrap">
                        ...
                        <div class="block-content">
                            <div class="testimonial-wrap slick-wrap">
                                <div class="slick-sliders" data-slidestoscroll="true" data-slidestoscroll="true"
                                    data-nav="1" data-dots="0" data-columns4="1" data-columns3="1" data-columns2="1"
                                        ...
                                        <div class="item">
                                            <div class="testimonial-item">
                                                ...
                                                <div class="testimonial-excerpt">
                                                    ...
                                                    optician plaque spinal tap stat strep...
                                                </div>
                                            </div>
                                            <div class="testimonial-image image-position-top">
                                                <div class="thumbnail">
                                                    <img width="110" height="110"
                                                        src="{{ asset('front_end/media/testimonial/1.jpg') }}"
                                                        alt="">
                                                </div>
                                    ...
                                    <div class="testimonial-content">
                                        <div class="item">
                                            ...
                                            <div class="testimonial-image image-position-top">
                                                <div class="thumbnail">
                                                    <img width="110" height="110"
                                                        src="{{ asset('front_end/media/testimonial/2.jpg') }}"
                                                        alt="">
                                                </div>
                                                <div class="testimonial-info">
                                    ...
                                    <div class="testimonial-content">
                                        <div class="item">
                                            ...
                                            <div class="testimonial-image image-position-top">
                                                <div class="thumbnail">
                                                    <img width="110" height="110"
                                                        src="{{ asset('front_end/media/testimonial/3.jpg') }}"
                                                        alt="">
                                                </div>
                                                <div class="testimonial-info">
                                    ...
                                    <div class="testimonial-content">
                                        <div class="item">
                                            ...
                                            <div class="testimonial-image image-position-top">
                                                <div class="thumbnail">
                                                    <img width="110" height="110"
                                                        src="{{ asset('front_end/media/testimonial/4.jpg') }}"
                                                        alt="">
                                                </div>
                                                <div class="testimonial-info">
                ...
                <div class="block block-newsletter layout-2 one-col">
                    <div class="block-widget-wrap">
                        <div class="newsletter-title-wrap">
                            <h2 class="newsletter-title">Latest From Pavitra!</h2>
                        </div>
                        <form id="newsletter-form" action="{{ route('subscribe') }}" method="post" class="newsletter-form">
                            @csrf
                            <input type="email" name="email" id="email" value="" size="40" placeholder="Email address">
