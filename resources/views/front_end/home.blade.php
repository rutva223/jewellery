                                            ...
                                            <div class="products-entry clearfix product-wapper">
                                                <div class="products-thumb">
                                                    ...
                                                    <div class="product-thumb-hover">
                                                        <a href="shop-details.html">
                                                            <img width="600" height="600"
                                                                src="{{ asset('front_end/media/product/2.jpg') }}"
                                                                class="post-image" alt="">
                                                            <img width="600" height="600"
                                                                src="{{ asset('front_end/media/product/2-2.jpg') }}"
                                                                class="hover-image back" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-button">
                                                ...
                                                <div class="products-content">
                                                    <div class="contents">
                                                        <div class="rating">
                                                            <div class="star star-5"></div><span class="count">(1
                                                                review)</span>
                                                        </div>
                                                    ...
                                                    <div class="product-thumb-hover">
                                                        <a href="shop-details.html">
                                                            <img width="600" height="600"
                                                                ...
                                                                class="post-image" alt="">
                                                            <img width="600" height="600"
                                                                src="{{ asset('front_end/media/product/3-2.jpg') }}"
                                                                class="hover-image back" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-button">
                                            ...
                                            <div class="products-entry clearfix product-wapper">
                                                <div class="products-thumb">
                                                    ...
                                                    <div class="product-thumb-hover">
                                                        <a href="shop-details.html">
                                                            <img width="600" height="600"
                                                                src="{{ asset('front_end/media/product/4.jpg') }}"
                                                                class="post-image" alt="">
                                                            <img width="600" height="600"
                                                                src="{{ asset('front_end/media/product/4-2.jpg') }}"
                                                                class="hover-image back" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-button">
                                                ...
                                                <div class="products-content">
                                                    <div class="contents">
                                                        <div class="rating">
                                                            <div class="star star-4"></div><span class="count">(2
                                                                reviews)</span>
                                                        </div>
                                            ...
                                            <div class="products-entry clearfix product-wapper">
                                                <div class="products-thumb">
                                                    ...
                                                    <div class="product-thumb-hover">
                                                        <a href="shop-details.html">
                                                            <img width="600" height="600"
                                                                src="{{ asset('front_end/media/product/13.jpg') }}"
                                                                class="post-image" alt="">
                                                            <img width="600" height="600"
                                                                src="{{ asset('front_end/media/product/13-2.jpg') }}"
                                                                class="hover-image back" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-button">
